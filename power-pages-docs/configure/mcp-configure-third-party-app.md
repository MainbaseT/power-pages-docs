...
This article shows you how to create a third-party app registration that AI clients use to authenticate with your MCP server. The third-party app acts as a client application that requests delegated permissions to access the MCP scope that your Microsoft Entra External ID application exposes.
...
- The name or application ID of the Microsoft Entra External ID app that you created
